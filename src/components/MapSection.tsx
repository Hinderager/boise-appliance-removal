        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Boise, ID and surrounding</p>
                <p className="text-gray-700">Treasure Valley communities</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="tel:2085059352" className="text-[#0b7fb6] hover:text-[#10477d] font-semibold text-lg transition-colors">
                  (208) 505-9352
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:info@boise-appliance-removal.com" className="text-[#0b7fb6] hover:text-[#10477d] transition-colors">
                  info@boise-appliance-removal.com
                </a>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <iframe
              ...
              title="Boise Appliance Removal Service Area - Boise, Idaho"
            />
          </div>
        </div>
