...
// Static reviews for appliance removal
const staticReviews = [
  {
    author: 'Mike S.',
    relative_time: '2 months ago',
    rating: 5,
    text: 'Had an old fridge in the garage that finally died. These guys came out same day and hauled it away. Quick, easy, no hassle. Exactly what I needed.',
  },
  {
    author: 'Sarah L.',
    relative_time: '1 month ago',
    rating: 5,
    text: 'We replaced our washer and dryer and needed the old ones gone. They showed up on time, disconnected everything, and had them out in under 20 minutes. Great service.',
  },
  {
    author: 'Tom R.',
    relative_time: '3 weeks ago',
    rating: 5,
    text: 'Professional crew. They removed our old stove and dishwasher during a kitchen remodel. Careful not to scratch the floors or walls. Would definitely use again.',
  },
  {
    author: 'Jennifer K.',
    relative_time: '2 weeks ago',
    rating: 5,
    text: 'Needed to clear out a rental property with several broken appliances. They took everything—fridge, stove, washer, dryer, even an old water heater. Fair price for all of it.',
  },
  {
    author: 'David M.',
    relative_time: '1 month ago',
    rating: 5,
    text: 'Called them for a freezer removal. They came the next day and handled it all. Appreciated that they recycle the appliances properly instead of just dumping them.',
  },
  {
    author: 'Lisa H.',
    relative_time: '3 months ago',
    rating: 5,
    text: 'Our AC unit was ancient and taking up space in the backyard. They hauled it away along with some other junk we had piled up. Very reasonable pricing.',
  },
  {
    author: 'Robert B.',
    relative_time: '2 months ago',
    rating: 5,
    text: 'Moving out and needed to get rid of a heavy old fridge fast. They were flexible with scheduling and got the job done quickly. Friendly team.',
  },
  {
    author: 'Amanda C.',
    relative_time: '1 week ago',
    rating: 5,
    text: 'Cleared out my late parents house and had a bunch of old appliances to remove. They were respectful and efficient. Made a tough situation easier.',
  },
]
