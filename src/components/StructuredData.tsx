...
const faqData = [
  {
    ...
    answer: 'Appliance removal costs depend on the type and number of appliances. Single-item pickups like a washer or dryer typically run $75-$125. Larger items like refrigerators may cost more. We provide free quotes with no hidden fees.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! We offer same-day appliance removal service in the Boise and Treasure Valley area. If you call in the morning, we can usually be there by afternoon. For urgent situations, call us at (208) 361-1982.',
  },
  {
    question: 'Do you disconnect appliances before removal?',
    answer: 'We can disconnect most electric appliances. For gas appliances, we recommend having a licensed technician disconnect the gas line before we arrive for safety reasons.',
  },
  {
  ...
  },
  {
    ...
    answer: 'No, you don\'t need to move anything. Our team handles all the heavy lifting from wherever the appliance is located—basement, upstairs, garage, anywhere. Just clear a path.',
  },
  {
...
export function StructuredData({ city = 'Boise' }: { city?: string }) {
  ...
  const structuredData = {
    ...
    "@type": "LocalBusiness",
    "name": `Appliance Removal Pros - ${city}`,
