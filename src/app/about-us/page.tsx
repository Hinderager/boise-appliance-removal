    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About Boise Appliance Removal</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Your trusted local appliance removal experts in the Treasure Valley.</p>
        </div>
      </section>
      <VisibleBreadcrumb />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Boise Appliance Removal is a locally owned and operated company serving homeowners and businesses throughout the Treasure Valley. We handle everything from old refrigerators and washers to commercial kitchen equipment and water heaters.</p>
              <p>We're not just about hauling stuff away. Every appliance we remove gets sorted for recycling, donation, or proper disposal. Most refrigerators, washers, and other metal-heavy appliances can be recycled rather than dumped in a landfill.</p>
              <p>Our team shows up on time, handles the heavy lifting, and cleans up when we're done. No hassle, no surprises.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">We prioritize recycling and responsible disposal over landfills.</p>
              </div>
              <div className="text-center">
      ...
      <section className="py-12 bg-dark-blue text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-white mb-4">Ready to Get Rid of That Old Appliance?</h2>
