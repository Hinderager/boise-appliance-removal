...
export const metadata: Metadata = {
  ...
  description: 'Professional appliance removal services in Boise, Meridian, Nampa, Caldwell & Eagle Idaho. We haul away refrigerators, washers, dryers, stoves, and all old appliances. Same-day service available. Call (208) 361-1982.',
  keywords: [
    'appliance removal Boise',
    'appliance pickup Boise Idaho',
    'refrigerator removal Boise',
    'washer dryer removal Meridian',
    'stove removal Nampa',
    'appliance disposal Caldwell',
    'appliance hauling Eagle Idaho',
    'old appliance removal Treasure Valley',
    'appliance recycling Boise',
    'dishwasher removal Idaho',
    'freezer removal Boise',
    'appliance junk removal',
  ],
  authors: [{ name: 'Appliance Removal Pros' }],
  openGraph: {
    ...
    siteName: 'Appliance Removal Pros',
    locale: 'en_US',
    type: 'website',
  },
  robots: {
