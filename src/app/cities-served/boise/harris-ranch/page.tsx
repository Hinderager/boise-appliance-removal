...
export const metadata: Metadata = {
  title: 'Appliance Removal Harris Ranch Boise | Boise Appliance Removal',
  description: 'Appliance Removal services in Harris Ranch, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['appliance removal Harris Ranch', 'appliance removal Harris Ranch Boise', 'Harris Ranch boise appliance removal'],
  alternates: {
    canonical: 'https://boise-appliance-removal.com/cities-served/boise/harris-ranch',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Appliance Removal in Harris Ranch
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need appliance removal services in the Harris Ranch area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Appliance Removal in Harris Ranch, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Upgrading appliances in your Harris Ranch kitchen? We remove the old ones, including proper disposal of refrigerants and recycling of metals.</p>
                <p>
