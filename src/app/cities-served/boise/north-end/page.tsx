...
export const metadata: Metadata = {
  title: 'Appliance Removal North End Boise | Boise Appliance Removal',
  description: 'Appliance Removal services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['appliance removal North End', 'appliance removal North End Boise', 'North End boise appliance removal'],
  alternates: {
    canonical: 'https://boise-appliance-removal.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Appliance Removal in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need appliance removal services in the North End area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Appliance Removal in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Old appliances from North End homes often include vintage pieces that need proper disposal. We handle refrigerators, washers, water heaters, and more with proper recycling and disposal.</p>
                <p>
