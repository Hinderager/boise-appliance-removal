...
export const metadata: Metadata = {
  title: 'Appliance Removal The Bench Boise | Boise Appliance Removal',
  description: 'Appliance Removal services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['appliance removal The Bench', 'appliance removal The Bench Boise', 'The Bench boise appliance removal'],
  alternates: {
    canonical: 'https://boise-appliance-removal.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Appliance Removal in The Bench
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for appliance removal in The Bench? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Appliance Removal in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Out with the old, in with the new. We remove old appliances from Bench homes and dispose of them properly, including handling refrigerant removal on cooling units.</p>
                <p>
