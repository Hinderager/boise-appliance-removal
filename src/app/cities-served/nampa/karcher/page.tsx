...
export const metadata: Metadata = {
  title: 'Appliance Removal Karcher Nampa | Boise Appliance Removal',
  description: 'Appliance Removal services in Karcher, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['appliance removal Karcher', 'appliance removal Karcher Nampa', 'Karcher nampa appliance removal'],
  alternates: {
    canonical: 'https://boise-appliance-removal.com/cities-served/nampa/karcher',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Appliance Removal in Karcher
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for appliance removal in Karcher? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Appliance Removal in Karcher, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Appliance disposal for Karcher area properties. Proper recycling.</p>
                <p>
