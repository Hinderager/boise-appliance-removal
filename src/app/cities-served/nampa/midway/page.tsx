...
export const metadata: Metadata = {
  title: 'Appliance Removal Midway Nampa | Boise Appliance Removal',
  description: 'Appliance Removal services in Midway, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['appliance removal Midway', 'appliance removal Midway Nampa', 'Midway nampa appliance removal'],
  alternates: {
    canonical: 'https://boise-appliance-removal.com/cities-served/nampa/midway',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Midway</span>
          </nav>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Appliance Removal in Midway
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Midway with professional appliance removal services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Appliance Removal in Midway, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Midway appliance removal with proper disposal and recycling.</p>
                <p>
                  Midway is known for its growing, family-oriented, suburban atmosphere.
                  With about ~8,000 residents, it's one of Nampa's most distinctive areas.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <ul className="space-y-2">
                  <li className="text-gray-700">Midway Park</li>
                  <li className="text-gray-700">Huckleberry Dog Park</li>
                  <li className="text-gray-700">Southwest Nampa growth area</li>
                </ul>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="text-gray-700">Iowa Avenue</li>
                </ul>
              </div>
            </div>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-dark-blue mb-6">
                What We Offer in Midway
              </h3>
              <ul className="grid md:grid-cols-2 gap-4">
                
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Growing residential area</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">New development and subdivisions</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Community parks and recreation</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Future mixed-use development planned</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Free estimates for Midway residents</span>
                </li>
              </ul>
            </div>
