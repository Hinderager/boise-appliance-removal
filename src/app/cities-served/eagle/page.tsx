...
export const metadata: Metadata = {
  title: 'Appliance Removal in Eagle, Idaho',
  ...
  alternates: { canonical: 'https://boise-appliance-removal.com/cities-served/eagle' },
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/cities-served/eagle/refrigerator-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/washer-dryer-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/stove-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/dishwasher-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/water-heater-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/freezer-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/microwave-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
              ...
              <Link href="/cities-served/eagle/commercial-equipment-removal" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
