...
export const metadata: Metadata = {
  ...
  description: 'Professional washer & dryer removal in Eagle, ID. Fast service, upfront pricing, eco-friendly disposal. Call (208) 505-9352.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Washer & Dryer Removal in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Fast, professional washer & dryer removal for Eagle homes and businesses.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>We provide washer & dryer removal throughout Eagle and the Treasure Valley.</p>
