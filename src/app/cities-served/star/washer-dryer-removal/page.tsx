...
export const metadata: Metadata = {
  ...
  description: 'Professional washer & dryer removal in Star, ID. Fast service, upfront pricing, eco-friendly disposal. Call (208) 505-9352.',
  alternates: { canonical: 'https://boise-appliance-removal.com/star/washer-dryer-removal' },
}
